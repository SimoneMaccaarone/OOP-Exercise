//                                  CIAO A TUTTI, ORA DIVERTITEVE A VEDE IL MIO CODDDDICE
...
let client8 = new Client('Martina', 'Esmeralda', [order1], 'Via della Felicità');
...
console.log('!!! Add & Remove EMPLOYEES !!!');
